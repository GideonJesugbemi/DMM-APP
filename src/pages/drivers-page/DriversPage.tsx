  ...
  return (
    <div>
      <div className="  mx-auto ">
        <div
          className="relative mt-18  border-blue-400 h-screen flex flex-col justify-center"
          style={{
        ...
        >
          ...
          <div className="bg-gray-100 flex justify-center  items-center p-5  border-red-400">
            <div className="flex justify-between mt-5 space-x-20">
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-sm font-light">
                  Get driven by professionals whenever required. we have the
                  best deals from our carefully vetted VIP Drivers.
                </p>
              </div>
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-sm font-light">
                  Hire from DMM for peace of mind and a guaranteed safe drive!
                  Defer your hire for free. 24hours before your trip
                </p>
              </div>
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-sm font-light">
                  You're ready to have a fantastic trip. We go where you go.
                </p>
              </div>
            </div>
          </div>
